...
#PLUGINS = ['pandoc_reader', 'tipue_search']
PLUGINS = ['pandoc_reader', 'tag_cloud', 'pelican-bibtex']

PANDOC_ARGS = [ '--mathjax', '--smart', '--filter=pandoc-citeproc', '--toc', '--toc-depth=2', '--number-sections', '--bibliography=MYHOMEPAGESRCPATH/references.bib',\
